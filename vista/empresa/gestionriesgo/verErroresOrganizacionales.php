...
echo "<script>object = [];</script>";
  ...
  $url = "https://creator.zoho.com/publishapi/v2/hq5colombia/gesti-n-del-riesgo/report/Reporte_Error_Organizacional?privatelink=x7sbtptk6V7QRwNnb6aZbbG7OWZTVZ9bRhw0hYB5HhtptN7R0J0n7BtdmBtFS8C10zeqPq7d5mMtHFUud92Qu9weHSXSJNVbPd3w&C_digo_Empresa=". $_SESSION['codigoEmpresa_user'];
...
<script>
	...
	var CargarSoporte = function(cell, formatterParams){ //plain text value
      if(cell.getRow().getData().Estado == "Pendiente Cargar Soporte"){
          return '<button class="btn btn-outline-info btn-sm"><i class="fas fa-upload"></i> Cargar Soporte</button>';
      }
    };
 ...
 var table = new Tabulator("#table-rendered", {
    ...
    {formatter:CargarSoporte, headerSort:false, width:150, hozAlign:"center",cellClick:function(e, cell){
